...
The version script then syncs the same version into `packages/rownd-python/pyproject.toml`.
...
Use `npm run check:python-versions` to verify that Python package versions match their workspace versions.
