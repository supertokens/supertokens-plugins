export const defaultTranslationsCommonDetails = {
  en: {
    ...
    PL_CD_SECTION_ACCOUNT_EMAIL_NO_EMAILS: "No email addresses",
    PL_CD_SECTION_ACCOUNT_PHONE_NUMBERS: "Phone numbers",
    PL_CD_SECTION_ACCOUNT_PHONE_NUMBERS_NO_PHONE_NUMBERS: "No phone numbers",
